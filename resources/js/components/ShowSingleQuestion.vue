		...
		<article class="question">
		    ...
		    <div class="user-question">
		    	<header>
		    		...
		    		<span class="badge badge-pill badge-warning"><i class="fa fa-folder-open-o" aria-hidden="true"></i> &nbsp; {{ question.category }}</span>	
		    	</header>
...
<script>
	...
	export default {
		...
		created() {
			axios.get(siteUrl + '/api/reaction/' + question.id + (currentUser ? '/' + currentUser.id : ''))
				.then((response) => {
