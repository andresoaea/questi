...
const GeneralSettings = Vue.component('general-settings',
	require('./GeneralSettings.vue'))

const ChangePassword =  Vue.component('change-password',
	require('./ChangePassword.vue'))

const Questions =  Vue.component('questions',
	require('./Questions.vue'))
...
let routes = [
    ...
    { path: '*', component: { template: '<h4 style="color: grey">404 Page not found</h4>' } }
  ]
